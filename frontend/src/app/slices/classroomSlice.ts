...
import { Classroom, ClassroomsState, BackendClassroom } from '../../utils/Interfaces';
...
export const fetchClassrooms = createAsyncThunk<Classroom[]>(
    ...
    async () => {
        ...
        const adjustedData: Classroom[] = data.map((classroom) => {
            const equipmentArray = Object.keys(classroom.equipment || {}).filter(
                (key) => classroom.equipment[key]
            );
            return {
...
export const addClassroom = createAsyncThunk<Classroom, BackendClassroom>(
    ...
    async (classroomData) => {
        ...
        const equipmentArray = Object.keys(data.equipment || {}).filter(
...
export const updateClassroom = createAsyncThunk<Classroom, BackendClassroom>(
...
export const deleteClassroom = createAsyncThunk<number, number>(
